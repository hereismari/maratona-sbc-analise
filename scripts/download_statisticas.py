...
parser.add_argument('--statisticas_url', type=str, default=URL_2017,
...
def download_statisticas(statistics_url, output_path):
...
def main():
  ...
  download_statisticas(args.statisticas_url, args.output_path)
